  ...
  return (
    <section id={id} className={`scroll-mt-24 px-5 py-20 sm:px-8 lg:py-28 ${className}`}>
      <motion.div {...fadeUp} className="mx-auto max-w-6xl">
        ...
        <h2 className="max-w-3xl text-[1.75rem] font-semibold tracking-[-0.06em] text-black sm:text-[2.5rem] lg:text-[3.25rem]">
          {title}
        </h2>
        {children}
      </motion.div>
    ...
    >
      ...
      <div className="relative flex flex-1 flex-col">
        ...
        <div className="mt-auto min-h-36 pt-12">
          <h3 className="text-[1.375rem] font-semibold leading-[0.95] tracking-[-0.06em] transition-transform duration-300 ease-out group-hover:-translate-y-8 group-focus:-translate-y-8">
            {track.title}
          </h3>
    ...
    <main id="top" className="min-h-screen overflow-hidden bg-[#eff0f2] text-black">
      ...
      <section className="relative px-5 pb-20 pt-32 sm:px-8 lg:pb-28 lg:pt-40">
        ...
        >
          ...
          <h1 className="mx-auto max-w-4xl text-[2.5rem] font-semibold leading-[0.92] tracking-[-0.075em] text-black sm:text-[4rem] lg:text-[5.5rem]">
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          {benefits.map((benefit, index) => (
            ...
            >
              ...
              <h3 className="text-base font-semibold tracking-[-0.055em]">{benefit.title}</h3>
      ...
      <section className="bg-white px-5 py-20 sm:px-8 lg:py-28">
        <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <motion.div {...fadeUp}>
            ...
            <h2 className="text-[1.75rem] font-semibold tracking-[-0.06em] sm:text-[2.5rem] lg:text-[3.25rem]">
          ...
          <motion.div {...fadeUp} className="grid gap-4 sm:grid-cols-2">
            {audiences.map((audience, index) => (
              ...
              >
                ...
                <h3 className="text-[1.375rem] font-semibold tracking-[-0.06em]">{audience}</h3>
              </div>
            ))}
          </motion.div>
        </div>
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <div key={label} className="rounded-[1.35rem] border border-black/8 bg-white p-6">
              ...
              <p className="mt-8 text-base font-semibold leading-tight tracking-[-0.055em]">{value}</p>
            </div>
          ))}
        </div>
      </Section>
      ...
      <Section id="themes" eyebrow="Featured Themes" title="The conversations that move beyond the local market.">
        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {themes.map((theme, index) => (
            <div
              key={theme}
              className={`flex min-h-44 items-end rounded-[1.35rem] p-6 text-base font-semibold tracking-[-0.055em] ${
                index === 0
                  ? 'bg-black text-white'
                  : index === 1
      ...
      <section id="register" className="px-5 py-20 sm:px-8 lg:py-28">
        ...
        >
          ...
          <div className="relative">
            ...
            <h2 className="mx-auto max-w-3xl text-[1.75rem] font-semibold leading-none tracking-[-0.065em] sm:text-[3.25rem]">
